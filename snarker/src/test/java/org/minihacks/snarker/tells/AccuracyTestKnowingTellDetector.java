...
public class AccuracyTestKnowingTellDetector {
	Logger logger = LoggerFactory.getLogger(AccuracyTestKnowingTellDetector.class);
	
	/*
	 * Consists of:
	 * General Inquirer: enlloss
	 * General Inquirer: know
	 * own observations
	 */
